...
Almost a year later to the day that I posted [Towards a Raku Foundation](https://dev.to/lizmat/towards-a-raku-foundation-3ne2) I'm glad to announce there is now The Raku Foundation in its bootstrapping phase: [https://raku.foundation](https://raku.foundation).

The [problem solving issue](https://github.com/raku/problem-solving/issues/477) has been closed, and now the real work can begin.
...
Many discussions were had about the [Articles Of Association](https://raku.foundation/ArticlesOfAssociation), and it took a long time to get to an agreement.  And then finally when there was an agreement, it was time to find a notary willing to notarize the Articles of Association.
...
The fourth hurdle was Napoleon Bonaparte.  Say what?  Well, yeah, in a way.  What I hadn't realized was that Dutch law (as most current European laws) was heavily influenced by the [Code Civil](https://en.wikipedia.org/wiki/Napoleonic_Code).  This contrary to the UK and USA, which is mostly based on [common English law](https://en.wikipedia.org/wiki/English_law).
...
There are basically two entities in the Netherlands that can confirm your foundation is indeed not-for-profit: [ANBI](https://www.belastingdienst.nl/wps/wcm/connect/bldcontenten/belastingdienst/business/business-public-benefit-organisations/public_benefit_organisations/what_is_pbo/what_is_a_pbo) (Algemeen Nut Beogende Instelling, aka Public Benefit Organization).
...
And [CBF](https://cbf.nl/information-english) (Centraal Bureau Fondsenwerving, aka Central Bureau for Fundraising).  This entity is much more strict: one of their prerequisites is to have a yearly overview of all finances of the foundation.  As we don't actually have a bank account yet, and we only (barely) exist for 6 weeks, this cannot be achieved before 2027.
